...
BEGIN
    ...
    FOR EQUIPO1 IN Cequipos_1 LOOP
        ...
        IF EQUIPO1.ID != EQUIPO2.ID THEN
            ...
            INSERT INTO PARTIDOS (ID, IDEQUIPOLOCAL,IDEQUIPOVISITANTE, FECHA_HORA, GOLESLOCAL, GOLESVISITANTE )
            VALUES (CONTADOR_PARTIDOS,EQUIPO1.ID, EQUIPO2.ID, NULL, NULL, NULL);
